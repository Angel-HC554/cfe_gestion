...
<div class="form-container">
    ...
    <div class="p-6">
        ...
        <form  id="vehicleForm2" action="{{ route('supervision_diaria.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="space-y-6">
                <div>
                    <h4 class="text-base font-semibold text-gray-800">1. Información General</h4>
                    <div class="mt-4 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
                        <div>
                            <label for="nombre_auxiliar" class="block text-sm font-medium text-gray-700">Auxiliar Verificador</label>
                            <select id="nombre_auxiliar" name="nombre_auxiliar" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required>
                        ...
                        <div class="sm:col-span-1">
                            ...
                            <input type="date" name="fecha" id="fecha" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" value="{{ date('Y-m-d') }}" required>
                        </div>

                        <div class="sm:col-span-1">
                            <label for="hora_inicio" class="block text-sm font-medium text-gray-700">Hora de Inicio</label>
                            <input type="time" name="hora_inicio" id="hora_inicio" class="p-2 mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required>
                        </div>

                        <div class="sm:col-span-1">
                            <label for="hora_fin" class="block text-sm font-medium text-gray-700">Hora de Fin</label>
                            <input type="time" name="hora_fin" id="hora_fin" class="p-2 mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required>
                        </div>
                    </div>
                </div>
                ...
                {{-- ======================================================== --}}
                <div>
                    <h4 class="text-base font-semibold text-gray-800">2. Lecturas Clave</h4>
                    <div class="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            <label for="kilometraje" class="block text-sm font-medium text-gray-700">Kilometraje / Odómetro</label>
                            <input type="number" name="kilometraje" id="kilometraje" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="Ej: 82000" required>
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-gray-700">Gasolina</label>
                            <div class="mt-2 space-x-4">
                                <label class="inline-flex items-center">
                                    <input type="radio" name="gasolina" value="1" class="form-radio" checked>
                                    <span class="ml-2">Sí</span>
                                </label>
                                <label class="inline-flex items-center">
                                    <input type="radio" name="gasolina" value="0" class="form-radio">
                ...
                {{-- ======================================================== --}}
                <div>
                    <h4 class="text-base font-semibold text-gray-800">3. Checklist de Verificación</h4>
                ...
                {{-- ======================================================== --}}
                <div>
                     <h4 class="text-base font-semibold text-gray-800">4. Reporte de Daños</h4>
                     <div class="mt-4 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-2">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <textarea id="golpes_coment" name="golpes_coment" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" placeholder="Transcriba los daños marcados en el diagrama. Ej: 'Rayón en puerta derecha'. Si no hay daños, déjelo en blanco."></textarea>
                        </div>
