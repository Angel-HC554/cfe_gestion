...
<div class="form-container">
    <div class="form-group" style="margin-bottom: 25px;">
        <label style="font-weight: bold; color: #016f2b; display: block; margin-bottom: 8px;">Vehiculo: <span
                style="font-weight: bold; color: black;">{{ $attributes->get('no_economico') }}</span></label>
    </div>
    <h2 style="color: #016f2b;"> Ingresa las fotos del vehiculo:</h2>
    @if ($errors->any() && $errors->hasBag('vehicleForm'))
    ...
    <form id="vehicleForm" action="{{ route('supervision_semanal.store') }}" method="post"
